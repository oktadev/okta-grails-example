...
<html>
    ...
    <body>
        ...
        <div id="show-accessory" class="content scaffold-show" role="main">
            ...
            <f:display bean="accessory" />
            <g:form resource="${this.accessory}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.accessory}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
